...
## INTRODUCTION
This Reproducible Pitch Presentation is part of the project under developing data products course at Coursera. We need to create a Shiny application and deploy it on Rstudio's servers. As part of the project we should use Slidify/Rstudio Presenter to prepare a reproducible pitch presentation about the application.
